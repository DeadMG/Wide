...
#define CreateLoad(...) CreateLoadFileLine(__VA_ARGS__, __FILE__, __LINE__)
#define CreateFieldExpression(...) CreateFieldExpressionFileLine(__VA_ARGS__, __FILE__, __LINE__)