...
namespace Wide {
    ...
    namespace Semantic {
        ...
        public:
            ...
            OverloadResolvable* GetCallableForFunction(const Parse::FunctionBase* f, Type* context, std::string name, Type* nonstatic_context, std::function<std::shared_ptr<Expression>(Parse::Name, Lexer::Range)> NonstaticLookup);
