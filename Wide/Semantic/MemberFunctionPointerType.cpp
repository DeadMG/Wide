...
OverloadSet* MemberFunctionPointer::CreateOperatorOverloadSet(Parse::OperatorName what, Parse::Access access, OperatorAccess kind) {
    ...
    if (!booltest)
        booltest = MakeResolvable([this](std::vector<std::shared_ptr<Expression>> args, Context c) {
